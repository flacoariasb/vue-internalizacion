<template>
    <div :key="key">
        <!-- <input id="pagina" value="1" hidden=""> -->
                    ...
                    <div class="box-inner">
                        <div class="box-header">
                            <h2>
                                ...
                                <span
                                    style="display: inline-block; position: relative; bottom: 1px; color: #498DB6;">&nbsp;&nbsp;Matriz
                                    de Internacionalización</span>
                            </h2>
                            <div class="box-icon">
                                <button @click="$router.push('/agregar')"
                                    style="position: absolute; top: 20; right: 0.2%; margin-top: -5px;"
                                    class="btn btn-primary">Agregar nuevo</button>
                                <!-- </a> -->
                            </div>
                        </div>
                        ...
                        <div v-else>
                            <br />
                            <!-- Input de busqueda -->
                            <div class="absolute right-0" style="margin-right: 10px;">
                            ...
                            <div>
                                <!-- Dropdown button -->
                                <div class="relative inline-block text-left" style="margin-left: 20px;">
                                    <button style="display: flex; justify-content: center; " class="btn btn-primary"
                                        @click="toggleList">
                                ...
                                <div class="flex">
                                    <p class="relative inline-block text-left">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                                    <button class="btn"
                                        style="display: flex; width: 60px; justify-content: center; border: 1px solid #ccc;"
                                        @click="toggleList2">
                                    ...
                                    <ul v-show="showList2" ref="dropdownList2" class="dropdown-list2">
                            ...
                            <br />
                            <div>
                                <div class="relative overflow-x-auto shadow-md sm:rounded-lg" style="margin-right: 20px; margin-left: 20px;">
                                    <table
                                        ...
                                        <tbody>
                                            <tr v-for="(row, rowIndex) in filteredItems" :key="rowIndex"
                                                ...
                                                <th v-for="(cell, cellIndex) in Object.values(row ? row : [])"
                                                    :key="cellIndex" scope="row" :class="[
                                                ...
                                                <th><button @click="editar(+row.INTER_ID)" type="button" 
                                ...
                                <nav class="flex items-center flex-column flex-wrap md:flex-row justify-between p-4"
                                    ...
                                    <span
                                        ...
                                        <span class="font-semibold text-gray-900 dark:text-white">{{
                                            showingNumberStartRowsCurrentPage
                            ...
                            " @click="onNextCurrentPage">Siguiente</span>
                                        ...
                                        <span class="font-normal text-gray-900 dark:text-white justify-end">Páginas en
                                            total: {{ totalPages
                                            }}</span>
                                    </div>
                                </nav>
...
import { computed, onMounted, onUnmounted, ref, watch, defineEmits, watchEffect } from 'vue'
...
const editar = (item: any) => {
    // router.push('/agregar')
  router.push(`/actualizar/${item}`);
}

const showList = ref(false);
const showList2 = ref(false);
const lblFilas = ref(10);
...
watchEffect(() => {
    if (data.value) {
        columns.value = [
            ...
            { head: data.value[0].SED_SEDE, isShowing: true, tittle: 'Sede' },
            { head: data.value[0].ICAR_CODIGO, isShowing: false, tittle: 'Código de carrera' },
            ...
            { head: data.value[0].PAI_PAIS, isShowing: false, tittle: 'País' },
            { head: data.value[0].PTIP_TIPO, isShowing: false, tittle: 'Tipo del movilizado participante / ejecutor' },
            ...
            { head: data.value[0].ARE_CODIGO, isShowing: false, tittle: 'Área de Conocimiento' },
            { head: data.value[0].FIN_TIPO, isShowing: false, tittle: 'Financiamiento' },
...
const optionsRowsPerPage = [10, 15, 50, 100, 500]
